...
namespace MatchMaker.Infrastructure.Data
{
    ...
    public partial class touchdbEntities : DbContext
    {
        ...
        public virtual int sp_FindAllMatchForUser(Nullable<System.Guid> userId)
        {
            var userIdParameter = userId.HasValue ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(System.Guid));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_FindAllMatchForUser", userIdParameter);
        }
    }
}
